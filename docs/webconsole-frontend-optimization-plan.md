...
- `validation/scripts/webconsole_utils_test.mjs` should assert that History page request sequencing and in-flight/queued refresh flags are not stored on the main `state`, and that stale queued History page responses remain ignored.
