...
- shell, write_file, edit_file, todo_write, task_create, task_update, feature_list_create, feature_list_update, create_goal, update_goal, agent_spawn, agent_status, agent_list, queue/delegate submission, skill command tools, custom extension tools, or finish
