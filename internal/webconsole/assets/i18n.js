(function bootstrapAegisI18n(global) {
  ...
  const zh = Object.freeze({
    ...
    'No turn limit': '不限制轮次',
    'Off, or 30m / 2h': '如 30m / 2h',
    'Off, or 2h / 1d': '如 2h / 1d',
    ...
    'Tool Lane': '工具通道',
    'Tool execute': '工具执行',
    'Awaiting model decision': '等待模型决策',
    'Verification': '验证',
    'Version': '版本',
    ...
    'Context report': '上下文报告',
    'Root peak': '根会话峰值',
    'Child peak': '子会话峰值',
    'Root aggregate': '根会话累计',
    'Child aggregate': '子会话累计',
    'Total input': '总输入',
    'Unknown usage': '未知用量',
    ...
    'Wall time': '墙钟耗时',
    'Session detail': '会话详情',
    'No request snapshots recorded.': '未记录请求快照。',
    'root': '根会话',
    'child': '子会话',
    'session': '会话',
    'peak': '峰值',
    ...
    'by': '作者',
    'Trust:': '信任：',
    'Job detail is loading.': '正在加载任务详情。',
    'Delivery is pending; the parent session has not consumed this background result yet.': '投递待处理；父会话尚未消费此后台结果。',
    'Pending delivery means the child/job result is recorded, but the parent run has not continued to accept it.': '待投递表示子会话或任务结果已记录，但父会话尚未继续运行并接收它。',
    'No data': '无数据',

    'Ignored malformed websocket payload from local server.': '已忽略本地服务器发来的格式错误 WebSocket 数据。',
    'The session failed.': '会话失败。',
    'Session launch is already in progress.': '会话启动正在进行。',
    'Interrupt steer sent.': '中断 steer 已发送。',
    'Steer queued for the running session.': '已为运行中的会话排队 steer 消息。',
    'Failed to queue steer input.': 'steer 输入排队失败。',
    'Plan revision sent.': '计划修改请求已发送。',
    'Plan Mode started.': '计划模式已启动。',
    'Failed to start session.': '会话启动失败。',
    'This session is not ready to continue. Refresh the session state and try again.': '当前会话尚不可继续。请刷新会话状态后重试。',
    'No running session is available for interrupt.': '没有可中断的运行中会话。',
    'Interrupt requested.': '已请求中断。',
    'Failed to request interrupt.': '请求中断失败。',
    'No running session is available to stop.': '没有可停止的运行中会话。',
    'No session is available to stop.': '没有可停止的会话。',
    'Stop already requested for this session.': '已请求停止此会话。',
    'Failed to stop the session.': '停止会话失败。',
    'No durable session is loaded.': '未加载持久化会话。',
    'Plan approval was not overridden.': '未覆盖计划审批限制。',
    'Plan approved and execution started.': '计划已批准并开始执行。',
    'Plan Mode cancelled.': '计划模式已取消。',
    'Type the requested plan change and send it.': '输入计划修改要求后发送。',
    'Plan Mode action failed.': '计划模式操作失败。',
    'Plan input request is no longer pending.': '计划输入请求已不再等待处理。',
    'Answer every Plan Mode question before submitting.': '请回答全部计划模式问题后再提交。',
    'Plan input answered.': '计划输入已回答。',
    'Failed to answer Plan Mode input.': '回答计划模式输入失败。',
    'Previously selected session is no longer available.': '之前选择的会话已不可用。',
    'Failed to delete session.': '删除会话失败。',
    'Failed to clear sessions.': '清空会话记录失败。',
    'Failed to uninstall skill.': '卸载技能失败。',
    'Provider test passed': '提供商测试通过',
    'Provider test failed.': '提供商测试失败。',
    'Settings save cancelled.': '已取消保存设置。',
    'Failed to save configuration.': '保存配置失败。',
    'Goal objective is required.': '请输入目标说明。',
    'Folder name is required.': '请输入文件夹名称。',
    'Folder name must not contain path separators.': '文件夹名称不能包含路径分隔符。',
    'Failed to create folder.': '创建文件夹失败。',
    'Failed to upload file.': '上传文件失败。',
    'Workspace refreshed.': '工作区已刷新。',
    'Failed to refresh workspace.': '刷新工作区失败。',
    'Failed to delete folder.': '删除文件夹失败。',
    'File name is required.': '请输入文件名。',
    'Choose a different file name.': '请选择其他文件名。',
    'File name must not contain path separators.': '文件名不能包含路径分隔符。',
    'Failed to rename file.': '重命名文件失败。',
    'Failed to delete file.': '删除文件失败。',
    'Deleted 1 selected item.': '已删除 1 个所选项目。',
    'Failed to delete selected items.': '删除所选项目失败。',
    'Delete selected item': '删除所选项目',
    'Delete selected items': '删除所选项目',
    'Delete folder': '删除文件夹',
    'File name': '文件名',
    'Send an interrupt steer message to the running session...': '向运行中的会话发送中断 steer 消息…',
    'Describe the objective to plan before execution...': '描述需要在执行前规划的目标…',
    'Live event relay reconnecting; REST session actions remain available.': '实时事件通道正在重连；仍可使用 REST 会话操作。',
    'Plan Mode enabled: next send starts a planning gate before execution.': '计划模式已启用：下次发送会在执行前启动规划门禁。',
    'Interrupt armed: next send requests preemption, then merges your steer prompt.': '中断已就绪：下次发送会请求抢占，然后合并你的 steer 提示。',
    'Steer running session: next send queues guidance into the current run.': '引导运行中的会话：下次发送会把指导内容排入当前运行。',
    'Open child session?': '打开子会话？',
    'Override validation coverage': '覆盖验证覆盖率限制',
    'Validation coverage blocks approval. Continue only if you accept the uncovered validation risk for this local session.': '验证覆盖率阻止了审批。仅当你接受此本地会话中未覆盖的验证风险时才继续。',
    'Override': '覆盖限制',
    'Clear the durable goal for this local session? This removes goal state and history links from the current session view.': '清除此本地会话的持久化目标？这会从当前会话视图中移除目标状态和历史链接。',
    'Uninstall skill': '卸载技能',
    'Custom Plan Mode Answer': '自定义计划模式回答',
    'Enter a custom answer for this Plan Mode question.': '输入此计划模式问题的自定义回答。',
    'Answer': '回答',
    'Use Answer': '使用回答',
    'Clear saved sessions': '清空已保存会话',
    'Clear all saved sessions? This will remove sessions and queue history.': '清空所有已保存会话？这会删除会话和队列历史。',
    'Clear all': '全部清空',
    'Save settings': '保存设置',
    'Save settings and write the entered API key to the local env file?': '保存设置并将输入的 API 密钥写入本地环境文件？',
    'Save settings to the local configuration files?': '将设置保存到本地配置文件？',
    'Save': '保存',
    'Sub-agent active runtime must be a duration such as 30m, 2h, 1h30m, or seconds.': '子 Agent 活跃运行时长必须使用 30m、2h、1h30m 或秒数等时长格式。',
    'Sub-agent absolute elapsed deadline must be a duration such as 30m, 2h, 1h30m, or seconds.': '子 Agent 总耗时截止值必须使用 30m、2h、1h30m 或秒数等时长格式。',
    'Context window tokens must be a non-negative integer.': '上下文窗口 Token 数必须是非负整数。',
    'Sub-agent turns per attempt must be a non-negative integer.': '子 Agent 每次尝试轮次必须是非负整数。',
    'Enable at least one positive sub-agent budget limit.': '请至少启用一个大于零的子 Agent 预算限制。',
    'Soft checkpoint turns must be a positive integer.': '软检查点轮次必须是正整数。',
    'Hard max turns must be a positive integer, or disable the hard limit.': '最大硬限制轮次必须是正整数，或者关闭硬限制。',
    'Plan Mode objective is required.': '请输入计划模式目标。',
    ...
    'Job detail is unavailable.': '任务详情不可用。',
    'Failed to load parent directory.': '加载上级目录失败。',
    'Failed to load session overview.': '加载会话概览失败。',
    'Failed to load recent activity.': '加载最近活动失败。',
    'Failed to load backend settings.': '加载后端设置失败。'
  });

  const zhPatterns = [
	[/^Workspace path (.+) is unavailable\. Showing workspace root instead\.$/, '工作区路径 $1 不可用，已改为显示工作区根目录。'],
	[/^Workspace path (.+) is unavailable\. Showing (.+) instead\.$/, '工作区路径 $1 不可用，已改为显示 $2。'],
	[/^Created folder (.+)\.$/, '已创建文件夹 $1。'],
	[/^Uploaded (.+)\.$/, '已上传 $1。'],
	[/^Download started for (.+)\.$/, '已开始下载 $1。'],
	[/^Renamed file to (.+)\.$/, '文件已重命名为 $1。'],
	[/^Deleted (\d+) selected items?\.$/, '已删除 $1 个所选项目。'],
	[/^Open child session "(.+)"\?$/, '打开子会话“$1”？'],
	[/^Uninstall skill (.+) from the local catalog\?$/, '从本地目录卸载技能 $1？'],
	[/^Delete session (.+)\?$/, '删除会话 $1？'],
	[/^Create a new folder in (.+)\.$/, '在 $1 中创建新文件夹。'],
	[/^Choose a new name for (.+)\.$/, '为 $1 选择新名称。'],
	[/^Delete workspace folder (.+) and all of its contents\? This cannot be undone from the web console\.$/, '删除工作区文件夹 $1 及其全部内容？此操作无法在 Web 控制台中撤销。'],
	[/^Delete workspace file (.+)\? This cannot be undone from the web console\.$/, '删除工作区文件 $1？此操作无法在 Web 控制台中撤销。'],
	[/^Delete (\d+) selected workspace items?\? Folders will be removed with all of their contents\. This cannot be undone from the web console\.$/, '删除 $1 个所选工作区项目？文件夹及其全部内容都会被删除。此操作无法在 Web 控制台中撤销。'],
	[/^Failed to load directory: (.+)$/, '加载目录失败：$1'],
	[/^Failed to load file: (.+)$/, '加载文件失败：$1'],
	[/^Provider test passed: (.+?)\. readable thinking returned\. Strategy: (.+)\.$/, '提供商测试通过：$1。已返回可读思考内容。策略：$2。'],
	[/^Provider test passed: (.+?)\. replay-only thinking returned\. Strategy: (.+)\.$/, '提供商测试通过：$1。已返回仅用于回放的思考内容。策略：$2。'],
    ...
    [/^(\d+) sessions?$/, '$1 个会话'],
    [/^Bounded view: ([\d,]+) sessions and ([\d,]+) requests omitted\. Aggregate totals are complete\.$/, '有界视图：省略 $1 个会话和 $2 个请求；汇总总数完整。'],
    [/^([\d,]+) ms$/, '$1 毫秒'],
    [/^(\d+) jobs?$/, '$1 个任务'],
    ...
    [/^Provider test passed: (.+)\.$/, '提供商测试通过：$1。'],
    ...
    [/^updated (.+)$/, '更新于 $1'],
    [/^(.+) · Interrupt$/, '$1 · 中断'],
    [/^(.+) · Awaiting model decision$/, '$1 · 等待模型决策'],
    [/^ID: (.+)$/, 'ID：$1'],
    [/^Stop session (.+)$/, '停止会话 $1'],
    [/^Goal Complete$/, '目标已完成'],
    [/^session Completed$/, '会话已完成'],
    ...
    [/^Download (.+)$/, '下载 $1'],
    [/^Rename (.+)$/, '重命名 $1'],
    [/^Delete (\d+) selected items?$/, '删除 $1 个所选项目'],
